  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('shipped_orders').snapshots(),
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              // Ensure total is treated as a double
              double totalAmount;
              if (order['total'] is int) {
                totalAmount = (order['total'] as int).toDouble();
              } else {
                totalAmount = order['total'] as double;
              }
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ShippedViewPage(
