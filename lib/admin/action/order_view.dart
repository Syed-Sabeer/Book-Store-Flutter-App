...
class OrderViewPage extends StatelessWidget {
  ...
  const OrderViewPage({super.key, required this.orderId, required this.order});
                ...
                ElevatedButton(
                  onPressed: () async {
                    try {
                      ...
                      // Add the current order to the 'shipped_orders' collection
                      await firestore.collection('shipped_orders').add(order);
                      ...
                      Navigator.pop(context); // Go back after marking as shipped
                    } catch (e) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Error marking order as shipped: $e')),
                      );
                    }
                  },
                  style: ElevatedButton.styleFrom(
